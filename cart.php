...
<div class="container-fluid m-3">	
    ...
    <?php 
    $qry = $conn->query("SELECT c.*,b.image_path,b.title,b.author FROM cart c inner join products b on b.id = c.product_id where c.customer_id ={$_SESSION['login_id']}");
    $total = 0;
    ?>
    <div class="row">
    <div class="col-md-8">
    			...
    			<li class="list-group-item" data-id="<?php echo $row['id'] ?>" data-price="<?php echo $row['price'] ?>">
    				<div class="d-flex w-100">
    					...
    					<div class="detail-field">
    						<p>Brand: <b><?php echo $row['title'] ?></b></p>
    						<p>Type: <b><?php echo $row['author'] ?></b></p>
    	...
    	<?php else: ?>
    		...
    		<center><b><span class="no-item">No Item </span> </b></center>
    	<?php endif; ?>
    </div>
    <div class="col-md-4">
    	<div class="card mb-4">
